...
const buttonVariants = cva(
    'inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0',
    {
        variants: {
            variant: {
                default:
                    'bg-primary text-white hover:text-black shadow hover:bg-primary-foreground dark:hover:bg-primary-light',
                ...
                secondary:
                    'bg-secondary hover:bg-forground-border text-text-primary border border-secondary-border stroke-primary fill-primary',
                primary_light:
